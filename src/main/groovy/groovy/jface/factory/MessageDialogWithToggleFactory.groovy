 ...
 * @author Frank
 */
public class MessageDialogWithToggleFactory extends AbstractSwtFactory {
	...
	public Object newInstance(FactoryBuilderSupport builder, Object name,
        ...
        String toggleMessage = attributes.remove("toggleMessage")?.toString()
        boolean toggleState = attributes.remove("toggleState") ?: false
        		
        		
        MessageDialogWithToggle dialog = new MessageDialogWithToggle((Shell)parent, title, titleImage, message, imageType, labels as String[], defaultIndex, toggleMessage, toggleState)

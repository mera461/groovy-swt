				...
				// first page for the wizard
		  		...
		  		{ 
	  				...
	  				jface.composite(it) {
						...
						label (  text:"Travel on:", layoutData:gridData(horizontalAlignment:GridData.BEGINNING))
						...
						// Date of return		
						label (style:"NONE", text:"Return on:", layoutData:gridData(horizontalAlignment:GridData.FILL))
						...
						// Departure				
						label (style:"NONE", text:"From:", layoutData:gridData(horizontalAlignment:GridData.FILL))			
						text( style:"BORDER", layoutData:gridData(horizontalAlignment:GridData.FILL, horizontalSpan:3));

						// Destination
						label (style:"NONE", text:"To:", layoutData:gridData(horizontalAlignment:GridData.FILL))				
						text( style:"BORDER", layoutData:gridData(horizontalAlignment:GridData.FILL, horizontalSpan:3))
						
						radioButton(  text:"Take a plane", layoutData:gridData(horizontalAlignment:GridData.FILL, horizontalSpan:3))
						radioButton( text: "Take the car", layoutData:gridData(horizontalAlignment:GridData.FILL, horizontalSpan:3))
	  			...
	  			wizardPage2 = wizardPage( title:"Step 2", description:"This is the second page", 
						...
						jface.composite( it ) {
							...
							label( text:"Set PageComplete to true/false: " )
